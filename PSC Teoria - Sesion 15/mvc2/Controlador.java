...
public class Controlador implements ActionListener {
	...
	private Vista vista;
	private CalcularNumeros calcnum;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(Vista.calcular())) {
			// try{
				...
				calcnum = new CalcularNumeros(vista);
				calcnum.execute();

				// NumeroThreshold numthres = calcnum.doInBackground();
				// List<Float> lf1 = numthres.verListaMenor();
				// List<Float> lf2 = numthres.verListaMayor();
